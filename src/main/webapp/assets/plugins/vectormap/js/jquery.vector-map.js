...
(function( $ ){
	...
	VectorCanvas.prototype = {
		...
		//����text�ڵ㣬Ŀ����Ҫ�ڵ�ͼ����ʾ���֣�ֻ���svg����chenting�����2013-05-31
    ...
    var WorldMap = function(params) {
		...
		var textStyle = mapData.style;
		
		this.container = params.container;//��ŵ�ͼ������
		
		this.defaultWidth = mapData.width;//��ͼ�Ŀ��
		this.defaultHeight = mapData.height;//��ͼ�ĸ߶�
		
		this.color = params.color;
		this.hoverColor = params.hoverColor;
		this.setBackgroundColor(params.backgroundColor);
		
		this.width = params.container.width();//�����Ŀ��
		this.height = params.container.height();//�����ĸ߶�
		...
		for(var key in mapData.pathes) {
			var path = this.canvas.createPath({path: mapData.pathes[key].path});//��ʼ���Ƶ�ͼ
			//Ϊ��ͼ�������
			var param = {name:mapData.pathes[key].name,x:mapData.pathes[key].x,y:mapData.pathes[key].y,style:textStyle};
