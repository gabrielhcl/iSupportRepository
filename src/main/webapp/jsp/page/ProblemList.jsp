	...
	<div class="row">
		<div class="col-md-12">
			<div class="card-box">
				...
				<button id="button"
					class="btn btn-default  waves-light"  onclick="location='${pageContext.request.contextPath}/problem/insertproblem'">
					添加
				</button>
				<br>
				<form modelAttribute="column" action="${pageContext.request.contextPath}/problem/problemlist" method="post" id="searchForm" name="searchForm" class="form-inline searchForm">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<table id="demo-custom-toolbar" data-toggle="table"
									...
									<thead>
										<tr>
											<th   data-sortable="true">问题编码</th>
											<th   data-sortable="true">项目名称</th>
											<th   data-sortable="true">问题级别</th>
									...
									<c:forEach items="${plist}" var="problem">
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/problem/toupdateproblem?pkProblem=${problem.pkProblem}"
												onclick="return confirmx('确认要修改该数据吗？', this.href)"
												class="btn btn-info btn-xs"> <i class="fa fa-trash"></i>修改
											</a> 
											<a
												href="${pageContext.request.contextPath}/problem/problemdetail?pkProblem=${problem.pkProblem}"
												onclick="return confirmx('确认要修改该数据吗？', this.href)"
												class="btn btn-info btn-xs"> <i class="fa fa-trash"></i>查看
											</a>
											<a
												href="${pageContext.request.contextPath}/problem/deleteproblem?pkProblem=${problem.pkProblem}"
