...
<body style="background-color: #FFFFFF">
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/problem/updateproblem?pkProblem=${problem.pkProblem}" method="post" modelAttribute="problem">
						...
						<div class="form-group" class="col-md-6">
							...
							<select class="form-control" name="problemtype">
									<option value="1" selected="selected">日常操作</option>
							...
							<select class="form-control" name="problemtype">
									...
									<option value="2" selected="selected">环境问题</option>
									<option value="3">数据库问题</option>
									<option value="4">打印问题</option>
									<option value="5">需求问题</option>
									<option value="6">其他问题</option>
							...
							<select class="form-control" name="problemtype">
									<option value="1">日常操作</option>
									<option value="2">环境问题</option>
									<option value="3" selected="selected">数据库问题</option>
									<option value="4">打印问题</option>
									<option value="5">需求问题</option>
									<option value="6">其他问题</option>
								</select>
							...
							<select class="form-control" name="problemtype">
									...
									<option value="2">环境问题</option>
									<option value="3">数据库问题</option>
									<option value="4" selected="selected">打印问题</option>
									<option value="5">需求问题</option>
									<option value="6">其他问题</option>
								</select>
							</c:if>
							...
							<select class="form-control" name="problemtype">
									...
									<option value="3">数据库问题</option>
									<option value="4">打印问题</option>
									<option value="5" selected="selected">需求问题</option>
									<option value="6">其他问题</option>
								</select>
							</c:if>
							...
							<select class="form-control" name="problemtype">
									...
									<option value="4">打印问题</option>
									<option value="5">需求问题</option>
									<option value="6" selected="selected">其他问题</option>
								</select>
							</c:if>
							</div>
						</div>
						...
						<div class="form-group" class="col-md-6">
							...
							<select class="form-control" name="supportmethod">
									<option value="1" selected="selected">顾问电话支持</option>
							...
							<select class="form-control" name="supportmethod">
									...
									<option value="2" selected="selected">400热线支持</option>
									<option value="3">远程支持</option>
									<option value="4">在线支持</option>
									<option value="5">现场支持</option>
								</select>
							...
							<select class="form-control" name="supportmethod">
									<option value="1">顾问电话支持</option>
									<option value="2">400热线支持</option>
									<option value="3" selected="selected">远程支持</option>
									<option value="4">在线支持</option>
									<option value="5">现场支持</option>
								</select>
							</c:if>
							...
							<select class="form-control" name="supportmethod">
									...
									<option value="2">400热线支持</option>
									<option value="3">远程支持</option>
									<option value="4" selected="selected">在线支持</option>
									<option value="5">现场支持</option>
								</select>
							</c:if>
							...
							<select class="form-control" name="supportmethod">
									...
									<option value="3">远程支持</option>
									<option value="4">在线支持</option>
									<option value="5" selected="selected">现场支持</option>
								</select>
							</c:if>
							</div>
						</div>
						...
						<div class="form-group" class="col-md-12">
							...
							<textarea class="summernote" name="detaileddescription" name="detaileddescription">
