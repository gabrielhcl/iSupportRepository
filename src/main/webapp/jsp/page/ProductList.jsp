	...
	<div class="row">
		<div class="col-md-12">
			<div class="card-box">
				...
				<button id="addbutton"
					class="btn btn-default  waves-light addbutton"  onclick="location='${pageContext.request.contextPath}/product/addproduct'">
					添加
				</button>
				<br>
				<form modelAttribute="product" action="${pageContext.request.contextPath}/product/productlist" method="post" id="searchForm" name="searchForm" class="form-inline searchForm">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<table id="demo-custom-toolbar" data-toggle="table"
									...
									<c:forEach items="${prolist}" var="product">
										<tr>
											...
											<td>
											<a
												href="${pageContext.request.contextPath}/product/productdetail?pkProduct=${product.pkProduct}"
												onclick="return confirmx('确认要删除该数据吗？', this.href)"
												class="btn btn-success btn-xs"> <i class="fa fa-trash"></i>查看
											</a>
											<a
												href="${pageContext.request.contextPath}/product/toupdate?pkProduct=${product.pkProduct}"
												onclick="return confirmx('确认要修改该数据吗？', this.href)"
												class="btn btn-info btn-xs"> <i class="fa fa-trash"></i>修改
											</a> <a
												href="${pageContext.request.contextPath}/product/deleteproduct?pkProduct=${product.pkProduct}"
												onclick="return confirmx('确认要删除该数据吗？', this.href)"
