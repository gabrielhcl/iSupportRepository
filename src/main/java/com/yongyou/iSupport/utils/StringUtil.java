...
public class StringUtil {
	...
	public static String readFile(String filePath) {
		try {
			...
			return executeRead(is);
		} catch (Exception e) {
			return null;
		}
	}

	public static String readFileForAsStream(String filePath) {
		try {
			InputStream is = StringUtil.class.getClass().getResourceAsStream(filePath);
			return executeRead(is);
		} catch (Exception e) {
			return null;
		}
	...
	private static String executeRead(InputStream is) throws IOException {
