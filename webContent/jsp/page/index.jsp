...
<body class="fixed-left">
	...
	<div id="wrapper">
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li class="has_sub"><a href="#" class="waves-effect"><i
							...
							<ul class="list-unstyled">
								<li><a href="${pageContext.request.contextPath}/menu/selectmenu?menuid=0">区域项目汇总展示</a></li>
						...
						<li class="has_sub"><a href="#" class="waves-effect"><i
								class="ti-gift"></i><span> 合同管理 </span></a>
							<ul class="list-unstyled">
		...
		<div class="content-page">
			...
			<div class="content">
				<!--                     <div class="container"> -->
				<iframe class="content-page" name="iframe_map" src="${iframesrc}" frameborder="0" width="1100px" height="500px" style="margin-left: 20px"></iframe>
